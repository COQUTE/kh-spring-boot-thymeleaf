...
const selectCommentList = async () => {
  ...
  const resp = await fetch(`/comments?boardNo=${boardNo}`); // GET 방식 요청
...
const insertChildComment = async (parentCommentNo, btn) => {
 ...
 * @param {*} btn 
 */
const updateComment = async (commentNo, btn) => {
