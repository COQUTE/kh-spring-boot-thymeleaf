...
public class EditBoardController {
	...
	public String boardUpdate(@PathVariable("boardCode") int boardCode,
			  				  ...
			  				  @RequestParam(value = "cp", required = false) int cp, RedirectAttributes ra) throws Exception {
		...
		if(result > 0) {
			...
			message = "수정 실패";
			// 현재 : editBoard/1/2004/update?cp=1 (POST)
			path = "update?cp=" + cp; // 목표 : editBoard/1/2004/update?cp=1 (GET)
