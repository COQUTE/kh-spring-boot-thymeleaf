...
public class ParameterController {
	 ...
	 * 
	 * [속성 추가 작성법]
	 * @RequestParam(value="key", required=true, defaultValue="1")
	 * 
	...
	public String paramTest2(@RequestParam("title") String title,
							 ...
							 @RequestParam("price") int price, // 형변환이 필요한 경우에는 파라미터 value값 필수 작성되어 있어야 함!
	...
	// - 제출된 파라미터 한번에 묶어서 얻어오기 (Map<String>)
	...
	// @ModleAttribut를 이용해 값이 필드에 세팅된 객체를
	// "커맨드 객체"라고 부른다.
	...
	public String paramTest4(/*@ModelAttribute*/ MemberDTO member) {
		...
		return "redirect:/param/main"; // 상대경로 작성법
		// =="redirect:/param/main"
		// (현재위치가 중요!
